...
const (
  rootKeyPath   = "ca-root/keys/root-ca.key"
  rootCertPath  = "ca-root/certs/root-ca.crt"
  rootCrlPath   = "ca-root/crls/root-ca.crl"
  signKeyPath   = "ca-sign/keys/sign-ca.key"
  signCertPath  = "ca-sign/certs/sign-ca.crt"
  signCrlPath   = "ca-sign/crls/sign-ca.crl"
  signChainPath = "ca-sign/certs/ca-chain.pem"
...
func NewCA(rootPass, signPass string) ([]string, error) {
  ...
  rootTmpl := &x509.Certificate{
    ...
    Subject:               pkix.Name{Organization: []string{"Example"}, CommonName: "Example Root CA"},
  ...
  signTmpl := &x509.Certificate{
    ...
    Subject:               pkix.Name{Organization: []string{"Example"}, CommonName: "Example Signing CA"},
